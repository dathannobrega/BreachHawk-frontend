...
export default function UserSettings() {
  ...
  return (
    <DashboardLayout>
      <PageTemplate title="Configurações">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="profile">
            <CardTemplate title="Informações do Perfil" description="Atualize suas informações pessoais e preferências">
              <FormTemplate title="" description="" onSubmit={handleProfileSubmit}>
                {/* Avatar Upload */}
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onChange={(e) => setProfileSettings({ ...profileSettings, preferredLanguage: e.target.value })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
          ...
          <TabsContent value="notifications">
            ...
            >
              <FormTemplate title="" description="" onSubmit={handleNotificationSubmit}>
          ...
          <TabsContent value="security">
            <CardTemplate title="Configurações de Segurança" description="Gerencie suas sessões e histórico de login">
              {/* Active Sessions */}
              <Card>
                <CardHeader>
                  <div className="flex items-center justify-between">

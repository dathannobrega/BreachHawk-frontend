...
export default function PlatformSettings() {
  ...
  const [smtpSettings, setSmtpSettings] = useState({
    ...
    host: "smtp.gmail.com",
    port: 587,
    username: "noreply@breachhawk.com",
    password: "",
    encryption: "tls" as "none" | "ssl" | "tls",
    fromName: "BreachHawk",
    fromEmail: "noreply@breachhawk.com",
  })
  ...
  const handleSmtpSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage("Erro ao salvar configurações SMTP")
    } finally {
      setSaving(false)
    }
  }
                    ...
                    <>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value: any) => setSmtpSettings({ ...smtpSettings, encryption: value })}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
